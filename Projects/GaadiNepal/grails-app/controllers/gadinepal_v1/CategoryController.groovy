...
class CategoryController {
    ...
    def s_show(Long id) {
        ...
        def vecList=Vehicle.findAllByCategory(categoryInstance)
        print("categoryCOntroller::::::::vecList:::::"+vecList)
        [categoryInstance: categoryInstance,vehicleInstanceLst:vecList]
    }
