...
<html>
	...
	<body>
		<a href="#edit-bidder" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>

		<div id="edit-bidder" class="content scaffold-edit" role="main">
			<h1>Update Bid</h1>
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${bidderInstance?.version}" />
				<fieldset class="form">
				...
				<fieldset class="buttons">
					<g:actionSubmit class="save" action="u_update" value="Update" />
				</fieldset>
			</g:form>
		</div>
	</body>
