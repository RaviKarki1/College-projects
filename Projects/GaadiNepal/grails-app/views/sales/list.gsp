			...
			<table>
				...
				<g:each in="${salesInstanceList}" status="i" var="salesInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                        ...
                        <td><g:link action="show" id="${salesInstance.id}">${fieldValue(bean: salesInstance, field: "vehicle_name")}</g:link></td>
                        ...
                        <td><g:link controller="Sales_reg" action="buy_req_list" id="${salesInstance.id}">
                           Info
                        </g:link>
                        </td>
