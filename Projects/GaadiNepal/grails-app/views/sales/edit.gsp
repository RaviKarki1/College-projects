...
<html>
	...
	<body>
		<a href="#edit-sales" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		%{--<div class="nav" role="navigation">--}%
			...
			%{--</ul>--}%
		%{--</div>--}%
		<div id="edit-sales" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${salesInstance?.version}" />
				<fieldset class="form">
