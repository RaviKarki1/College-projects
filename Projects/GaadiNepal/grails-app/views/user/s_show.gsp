	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				%{--<g:if test="${userInstance?.auction}">--}%
				%{--<li class="fieldcontain">--}%
					%{--<span id="auction-label" class="property-label"><g:message code="user.auction.label" default="Auction" /></span>--}%
					%{----}%
						%{--<g:each in="${userInstance.auction}" var="a">--}%
						%{--<span class="property-value" aria-labelledby="auction-label"><g:link controller="auction" action="show" id="${a.id}">${a?.encodeAsHTML()}</g:link></span>--}%
						%{--</g:each>--}%
					%{----}%
				%{--</li>--}%
				%{--</g:if>--}%
			%{----}%
				%{--<g:if test="${userInstance?.bidder}">--}%
				%{--<li class="fieldcontain">--}%
					%{--<span id="bidder-label" class="property-label"><g:message code="user.bidder.label" default="Bidder" /></span>--}%
					%{----}%
