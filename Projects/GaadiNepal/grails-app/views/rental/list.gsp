		...
		<div id="list-rental" class="content scaffold-list" role="main">
			...
			<table>
				...
				<g:each in="${rentalInstanceList}" status="i" var="rentalInstance">
                    %{--<g:if test="${rentalInstance.status==false}">--}%
						...
						<td>${fieldValue(bean: rentalInstance, field: "price")}</td>
                         ...
                         <td> <g:link controller="rent_Rreg_Det" action="rentalSpecificList" id="${rentalInstance.id}">
                             List registrations
                         </g:link></td>
					

                        %{--<td>--}%
                            %{--<g:link controller="rent_Rreg_Det" action="create" id="${rentalInstance?.id}">rent--}%
