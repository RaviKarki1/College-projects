...
<html>
	...
	<body>
		<a href="#edit-rental" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		%{--<div class="nav" role="navigation">--}%
			...
			%{--</ul>--}%
		%{--</div>--}%
		<div id="edit-rental" class="content scaffold-edit" role="main">
