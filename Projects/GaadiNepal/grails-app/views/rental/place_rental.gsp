...
<body>
<a href="#create-rental" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
%{--<div class="nav" role="navigation">--}%
    ...
    %{--</ul>--}%
%{--</div>--}%
<div id="create-rental" class="content scaffold-create" role="main">
